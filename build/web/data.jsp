        ...
        <div class="data" >
            ...
            <table border='1'>
                <c:forEach items="${vehicles}" var="item">
                    ...
                    <td><a href="MainServlet?command=del&id=${item.id}"><button class="btn btn-primary btn-block btn-large">del</button></a></td>

                    </tr>
                </c:forEach>
                <tr>
                <form method="POST" action="MainServlet?command=add">
                    <h1><td>${vehiclesSize}</td></h1>
                    <td><input name="make" type="text" placeholder="make"/></td>
                    <td><input name="model" type="text" placeholder="model"/></td>
                    <td><button type="submit" class="btn btn-primary btn-block btn-large">add</button></td>
                </form>
                </tr>
            </table>            
